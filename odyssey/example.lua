...
function AddWindow(options)
	...
	options = Library:validate({
		name = string.format('digital framework <font color="rgb(%d, %d, %d)">[beta]</font> | developed by windowcheater', Library.Colors.Accent.R * 255, Library.Colors.Accent.G * 255, Library.Colors.Accent.B * 255),
...
do -- random
    ...
    aimbot_tab:AddTab({name = "rage"})  -- SUBTAB
    local section0 = aimbot_tab:AddSection({tab = "rage",name = "main",height = "fill"})

    local toggle1 = section0:AddToggle({name = "enabled"}) 
    toggle1:AddKeybind()

    local toggle1 = section0:AddToggle({name = "rapid fire"})
    toggle1:AddKeybind()
    ...
    aimbot_tab:AddTab({name = "visuals"})  -- SUBTAB
    aimbot_tab:AddTab({name = "misc"})  -- SUBTAB
end
